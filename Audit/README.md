...
This script permit to audit the configuration of your Linux server.

## Hardening
### Minimal level recommendations
- [x] R30 - Removing the unused user accounts
- [ ] R31 - User password strength
- [x] R53 - Avoiding files or directories without a known user or group
- [x] R54 - Setting the sticky bit on the writable directories
...
- [x] R3 - Activating the UEFI secure boot
- [x] R5 - Configuring a password on the bootloader
...
- [x] R33 - Ensuring the imputability of administration actions
- [x] R34 - Disabling the service accounts
- [x] R35 - Uniqueness and exclusivity of service accounts
- [x] R39 - Sudo configuration guidelines
...
- [x] R63 - Disabling non-essential features of service
